...
The table of results should contain one column: Name of the client (name).
...
/* Task 3
Write an sql query to return final balance in 1 column,
Conditions:
1. Negative payments are credit card payments
2. positive payments are incoming transactions
3. There is a Fee for holding credit card which you have to pay 5 rupees per month.However you will be not charged for a given month
	if you made 3 credit card Payments for a total cost of at least 100rupees with in a month.
